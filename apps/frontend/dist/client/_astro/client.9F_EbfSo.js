 ...
 * @license MIT
 **/ let A;
const v = typeof window < 'u' && window.trustedTypes;
if (v)
  try {
    A = v.createPolicy('vue', { createHTML: (t) => t });
  } catch {}
const z = A ? (t) => A.createHTML(t) : (t) => t,
  ...
  et = {
    ...
    createElement: (t, e, n, i) => {
      const s =
        e === 'svg'
          ? a.createElementNS(k, t)
          : e === 'mathml'
            ? a.createElementNS(tt, t)
            : n
    ...
    insertStaticContent(t, e, n, i, s, o) {
      ...
      if (s && (s === o || s.nextSibling))
        ...
        C.innerHTML = z(i === 'svg' ? `<svg>${t}</svg>` : i === 'mathml' ? `<math>${t}</math>` : t);
        const c = C.content;
        if (i === 'svg' || i === 'mathml') {
...
function ct(t, e, n) {
  ...
  if (n && !s) {
    if (e)
      ...
      else for (const r in e) n[r] == null && S(i, r, '');
    for (const r in n) r === 'display' && (o = !0), S(i, r, n[r]);
  } else if (s) {
    if (e !== n) {
      const r = i[rt];
      r && (n += ';' + r), (i.cssText = n), (o = ot.test(n));
    }
  } else e && t.removeAttribute('style');
  E in t && ((t[E] = o ? i.display : ''), t[st] && (i.display = 'none'));
}
const T = /\s*!important$/;
function S(t, e, n) {
  if (D(n)) n.forEach((i) => S(t, e, i));
  else if ((n == null && (n = ''), e.startsWith('--'))) t.setProperty(e, n);
  else {
    const i = ft(t, e);
    T.test(n) ? t.setProperty($(i), n.replace(T, ''), 'important') : (t[i] = n);
  }
}
...
function ft(t, e) {
  ...
  if (n) return n;
  let i = x(e);
  if (i !== 'filter' && i in t) return (g[e] = i);
  i = J(i);
  for (let s = 0; s < w.length; s++) {
    const o = w[s] + i;
    if (o in t) return (g[e] = o);
  }
  return e;
}
const M = 'http://www.w3.org/1999/xlink';
function N(t, e, n, i, s, o = Z(e)) {
  i && e.startsWith('xlink:')
    ...
    : n == null || (o && !B(n))
      ? t.removeAttribute(e)
      : t.setAttribute(e, o ? '' : y(n) ? String(n) : n);
}
function _(t, e, n, i, s) {
  ...
  if (e === 'value' && o !== 'PROGRESS' && !o.includes('-')) {
    const c = o === 'OPTION' ? t.getAttribute('value') || '' : t.value,
      f = n == null ? (t.type === 'checkbox' ? 'on' : '') : String(n);
    (c !== f || !('_value' in t)) && (t.value = f),
...
function pt(t) {
  ...
  return [t[2] === ':' ? t.slice(3) : $(t.slice(2)), e];
}
let b = 0;
const dt = Promise.resolve(),
  mt = () => b || (dt.then(() => (b = 0)), (b = Date.now()));
function ht(t, e) {
  const n = (i) => {
    if (!i._vts) i._vts = Date.now();
    else if (i._vts <= n.attached) return;
    Q(St(i, n.value), e, 5, [i]);
  };
...
function bt(t, e, n, i) {
  if (i) return !!(e === 'innerHTML' || e === 'textContent' || (e in t && P(e) && I(n)));
  if (
    e === 'spellcheck' ||
    e === 'draggable' ||
    e === 'translate' ||
  ...
  return P(e) && m(n) ? !1 : e in t;
}
const W = F({ patchProp: gt }, et);
let d,
  R = !1;
function At() {
  return d || (d = U(W));
...
const Ct = (...t) => {
    ...
    return (
      (e.mount = (i) => {
        ...
        !I(o) && !o.render && !o.template && (o.template = s.innerHTML),
...
function G(t) {
  return m(t) ? document.querySelector(t) : t;
}
const Tt = () => {},
  wt = Y({
    ...
    setup({ name: t, value: e, hydrate: n }) {
      if (!e) return () => null;
      let i = n ? 'astro-slot' : 'astro-static-slot';
      return () => h(i, { name: t, innerHTML: e });
    },
  });
var Mt = wt;
let O = new WeakMap();
var Lt =
  (t) =>
  async (e, n, i, { client: s }) => {
    if (!t.hasAttribute('ssr')) return;
    const o = e.name ? `${e.name} Host` : void 0,
      r = {};
    for (const [u, p] of Object.entries(i))
      r[u] = () => h(Mt, { value: p, name: u === 'default' ? void 0 : u });
    const c = s !== 'only',
      f = c ? Et : Ct;
    let l = O.get(t);
    if (l) (l.props = n), (l.slots = r), l.component.$forceUpdate();
    else {
      l = { props: n, slots: r };
      const u = f({
        name: o,
        render() {
          let p = h(e, l.props, l.slots);
          return (l.component = this), Nt(e.setup) && (p = h(V, null, p)), p;
        },
      });
      (u.config.idPrefix = t.getAttribute('prefix') ?? void 0),
        await Tt(),
        u.mount(t, c),
        O.set(t, l),
