 ...
 */ var rt = { autoSleep: 120, force3D: 'auto', nullTargetWarn: 1, units: { lineHeight: '' } },
  ...
  Wi = function (t, e, i, r) {
    wt.length && !q && ve(), t.render(e, i, !!(q && e < 0 && ai(t))), wt.length && !q && ve();
  },
  Gi = function (t) {
    var e = parseFloat(t);
    return (e || e === 0) && (t + '').match(Bi).length < 2 ? e : Y(t) ? t.trim() : t;
  },
  $i = function (t) {
    return t;
  },
  ...
  re = function (t) {
    ...
    if (Q(t.inherit)) for (; e; ) i(t, e.vars.defaults), (e = e.parent || e._dp);
    return t;
  },
  Yr = function (t, e) {
  ...
  ke = function (t) {
    return (t._end = B(t._start + (t._tDur / Math.abs(t._ts || t._rts || G) || 0)));
  },
  Ce = function (t, e) {
    var i = t._dp;
    return (
  ...
  Qi = function (t, e) {
    ...
    if (
      ((e._time || (!e._dur && e._initted) || (e._start < t._time && (e._dur || !e.add))) &&
        ((i = be(t.rawTime(), e)),
        (!e._dur || ce(0, e.totalDuration(), i) - e._tTime > G) && e.render(i, !0)),
  ...
  _t = function (t, e, i, r) {
    return (
      e.parent && Ot(e),
      (e._start = B((yt(i) ? i : i || t !== E ? at(t, i, e) : t._time) + e._delay)),
      (e._end = B(e._start + (e.totalDuration() / Math.abs(e.timeScale()) || 0))),
      Ki(t, e, '_first', '_last', t._sort ? '_start' : 0),
      Ye(e) || (t._recent = e),
      r || Qi(t, e),
    ...
    if (
      ...
      e < 0 && Ue(t, e, i, !0),
        ...
        (e >= t._tDur || e < 0) &&
          t.ratio === s &&
          (s && Ot(t, 1),
          !i && !q && (it(t, s ? 'onComplete' : 'onReverseComplete', !0), t._prom && t._prom()));
  ...
  Kr = { _start: 0, endTime: oe, totalDuration: oe },
  at = function u(t, e, i) {
    var r = t.labels,
      n = t._recent || Kr,
  ...
  Zr = function (t, e, i) {
    return (
      ...
      t.forEach(function (r) {
        var n;
        return (Y(r) && !e) || Hi(r, 1) ? (n = i).push.apply(n, ot(r)) : i.push(r);
      }) || i
    );
  },
  ot = function (t, e, i) {
    return R && !e && R.selector
      ? R.selector(t)
      : Y(t) && !i && (Be || !Zt())
        ? Xe.call((e || ei).querySelectorAll(t), 0)
        : $(t)
          ? Zr(t, i)
          : Hi(t)
            ? Xe.call(t, 0)
  ...
  qe = function (t) {
    return (
      ...
      function (e) {
        ...
        return ot(
          e,
          i.querySelectorAll ? i : i === t ? ae('Invalid scope') || ei.createElement('div') : t,
        );
      }
    );
  },
      ...
      function (c, d, p) {
        ...
        if (!m) {
          ...
          for (
            ...
            (v = (w % b) - y),
              (T = x - ((w / b) | 0)),
              (m[w] = g = f ? Math.abs(f === 'y' ? T : v) : Fi(v * v + T * T)),
              g > P && (P = g),
              g < O && (O = g);
          r === 'random' && Ji(m),
            (m.max = P - O),
  ...
  er = function (t, e) {
    ...
    return (
      !i &&
        dt(t) &&
        ((r = i = t.radius || ct),
        t.values ? ((t = ot(t.values)), (n = !yt(t[0])) && (r *= r)) : (t = We(t.increment))),
      kt(
        e,
        i
          ? F(t)
  ...
  ue = function (t) {
    for (var e = 0, i = '', r, n, s, a; ~(r = t.indexOf('random(', e)); )
      (s = t.indexOf(')', r)),
        ...
        (i += t.substr(e, r - e) + ir(a ? n : +n[0], a ? 0 : +n[1], +n[2] || 1e-5)),
        (e = s + 1);
        ...
        var e = t.name,
          ...
          r =
            e && !i && t.init
              ...
              : t,
          n = { init: oe, render: _i, add: oi, kill: xn, modifier: yn, rawVars: 0 },
          s = { targetTest: 0, get: 0, getSetter: hi, aliases: {}, register: 0 };
        if ((Zt(), t !== r)) {
          if (tt[e]) return;
          st(r, st(Te(t, n), s)),
            $t(r.prototype, $t(n, Te(t, s))),
            (tt[(r.prop = e)] = r),
            t.targetTest && (ge.push(r), (ri[e] = 1)),
        ...
        wake: function () {
          Vi &&
            (!Be &&
              ...
              Ui(xe || ht.GreenSockGlobals || (!ht.gsap && ht) || {}),
              sr.forEach(ar)),
  ...
  fn = function (t) {
    ...
    return i && e.length > 1 && i.config
      ? i.config.apply(null, ~t.indexOf('{') ? [on(e[1])] : un(t).split(',').map(Gi))
      : S._CE && sn.test(t)
        ? S._CE('', t)
        : i;
  },
  ...
  Bt = function (t, e, i, r) {
    ...
    return (
      Z(t, function (a) {
        ...
        for (var o in n)
          S[s + (o === 'easeIn' ? '.in' : o === 'easeOut' ? '.out' : '.inOut')] = S[a + '.' + o] =
            n[o];
      }),
      n
    );
  ...
  he = (function () {
    ...
    return (
      ...
      (t.totalDuration = function (i) {
        return arguments.length
          ? ((this._dirty = 0),
            Qt(this, this._repeat < 0 ? i : (i - this._repeat * this._rDelay) / (this._repeat + 1)))
          : this._tDur;
      }),
      ...
      (t.time = function (i, r) {
        return arguments.length
          ? this.totalTime(
              Math.min(this.totalDuration(), i + xi(this)) % (this._dur + this._rDelay) ||
                (i ? this._dur : 0),
              r,
            )
          : this._time;
      ...
      (t.progress = function (i, r) {
        return arguments.length
          ? this.totalTime(
              this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - i : i) + xi(this),
              r,
            )
          : this.duration()
      ...
      (t.timeScale = function (i, r) {
        ...
        return (
          ...
          this.totalTime(ce(-Math.abs(this._delay), this.totalDuration(), n), r !== !1),
          ke(this),
          Xr(this)
        );
      }),
              ...
              i
                ...
                : (Zt(),
                  ...
                  this.totalTime(
                    ...
                    this.progress() === 1 && Math.abs(this._zTime) !== G && (this._tTime -= G),
                  ))),
            this)
          : this._ps;
      }),
      ...
      (t.endTime = function (i) {
        return (
          this._start + (Q(i) ? this.totalDuration() : this.duration()) / Math.abs(this._ts || 1)
        );
      }),
      ...
      (t.reversed = function (i) {
        return arguments.length
          ? (!!i !== this.reversed() && this.timeScale(-this._rts || (i ? -1e-8 : 0)), this)
          : this._rts < 0;
      }),
...
var K = (function (u) {
  ...
  function t(i, r) {
    ...
    return (
      ...
      E && _t(i.parent || E, mt(n), r),
      i.reversed && n.reverse(),
      i.paused && n.paused(!0),
      i.scrollTrigger && Zi(mt(n), i.scrollTrigger),
      n
    );
  }
  var e = t.prototype;
  return (
      ...
      if ((this !== E && h > o && r >= 0 && (h = o), h !== this._tTime || s || l)) {
        if (
          ...
          if (
            ...
            h === o
              ? ((_ = this._repeat), (c = f))
              : ((g = B(h / m)), (_ = ~~g), _ && _ === g && ((c = f), _--), c > f && (c = f)),
            (g = Kt(this._tTime, m)),
            ...
            if (
              ...
              (a = O ? 0 : h % f ? f : h),
              (this._lock = 1),
              (this.render(a || (P ? 0 : B(_ * m)), n, !f)._lock = 0),
              (this._tTime = h),
        ...
        if (
          (this._hasPause &&
            !this._forcing &&
            this._lock < 2 &&
            ((x = $r(this, B(a), B(c))), x && (h -= c - (c = x._start))),
          (this._tTime = h),
          (this._time = c),
          (this._act = !v),
          this._initted ||
            ...
            (this._zTime = r),
            (a = 0)),
          !a && h && !n && !g && (it(this, 'onStart'), this._tTime !== h))
        )
          return this;
        if (c >= a && r >= 0)
          for (d = this._first; d; ) {
            ...
            if (((p = d._prev), (d._act || k <= d._end) && d._ts && x !== d)) {
              ...
              if (
                (d.render(
                  d._ts > 0
                    ? (k - d._start) * d._ts
                    : (d._dirty ? d.totalDuration() : d._tDur) + (k - d._start) * d._ts,
                  n,
                  s || (q && ai(d)),
                ),
                c !== this._time || (!this._ts && !y))
        ...
        if (
          x &&
          !n &&
          (this.pause(), (x.render(c >= a ? 0 : -1e-8)._zTime = c >= a ? 1 : -1), this._ts)
        )
        ...
        this._onUpdate && !n && it(this, 'onUpdate', !0),
          ((h === o && this._tTime >= this.totalDuration()) || (!h && a)) &&
            ...
            (this._lock ||
              ((r || !f) && ((h === o && this._ts > 0) || (!h && this._ts < 0)) && Ot(this, 1),
              !n &&
                !(r < 0 && !a) &&
                (h || a || !o) &&
    ...
    (e.clear = function (r) {
      ...
      return (
        this._dp && (this._time = this._tTime = this._pTime = 0), r && (this.labels = {}), Ft(this)
      );
    }),
    ...
    (t.updateRoot = function (r) {
      if ((E._ts && (Wi(E, be(r, E)), (Xi = et.frame)), et.frame >= gi)) {
        gi += rt.autoSleep || 120;
        var n = E._first;
...
st(K.prototype, { _lock: 0, _hasPause: 0, _forcing: 0 });
var hn = function (t, e, i, r, n, s, a) {
  ...
  oi = function (t, e, i, r, n, s, a, o, f, h) {
    ...
    var l = t[e],
      c =
        i !== 'get'
          ...
          : F(l)
            ? f
              ? t[e.indexOf('set') || !F(t['get' + e.substr(3)]) ? e : 'get' + e.substr(3)](f)
              : t[e]()
            : l,
      d = F(l) ? (f ? pn : gr) : fi,
      p;
    if (
      (Y(r) &&
        ...
        r.charAt(1) === '=' && ((p = Xt(c, r) + (W(c) || 0)), (p || p === 0) && (r = p))),
      !h || c !== r || Ge)
    )
      return !isNaN(c * r) && r !== ''
        ? ((p = new j(
          ...
          (this._pt = p))
        : (!l && !(e in t) && ii(e, r), hn.call(this, t, e, c, r, d, o || rt.stringFilter, f));
  },
  _n = function (t, e, i, r, n) {
    if ((F(t) && (t = se(t, n, e, i, r)), !dt(t) || (t.style && t.nodeType) || $(t) || Li(t)))
  ...
  dr = function (t, e, i, r, n, s) {
    ...
    if (
      tt[t] &&
      (a = new tt[t]()).init(n, a.rawVars ? e[t] : _n(e[t], r, n, s, i), i, r, s) !== !1 &&
      ((i._pt = o = new j(i._pt, n, t, 0, 1, a.render, a, 0, a.priority)), i !== Yt)
    )
  ...
  ui = function u(t, e, i) {
    ...
    if (
      (T && (!c || !n) && (n = 'none'),
      (t._ease = Lt(n, Gt.ease)),
      (t._yEase = l ? hr(Lt(l === !0 ? n : l, Gt.ease)) : 0),
      ...
      if (
        ...
        _ &&
          ...
          e < 0 && h && a && !d ? _.render(-1, !0) : _.revert(h && p ? me : Nr),
          (_._lazy = 0)),
        s)
      ) {
        if (
          ...
          (t._startAt._dp = 0),
          (t._startAt._sat = t),
          e < 0 && (q || (!a && !d)) && t._startAt.revert(me),
          a && p && e <= 0 && i <= 0)
        ) {
          e && (t._zTime = e);
          return;
        ...
        if (
          ...
          I && (P[M.prop] = I),
          Ot((t._startAt = N.set(m, P))),
          (t._startAt._dp = 0),
          (t._startAt._sat = t),
          e < 0 && (q ? t._startAt.revert(me) : t._startAt.render(-1, !0)),
          (t._zTime = e),
          !a)
        )
          u(t._startAt, G, G);
      ...
      for (t._pt = t._ptCache = 0, o = (p && Q(o)) || (o && !p), w = 0; w < m.length; w++) {
        if (
          ((b = m[w]),
          (A = b._gsap || si(m)[w]._gsap),
          (t._ptLookup[w] = X = {}),
          Ve[A.id] && wt.length && ve(),
          (V = x === m ? w : x.indexOf(b)),
          M &&
            (D = new M()).init(b, I || g, t, V, x) !== !1 &&
            ((t._pt = O = new j(t._pt, b, D.name, 0, 1, D.render, D, 0, D.priority)),
          ...
          for (P in g)
            tt[P] && (D = dr(P, g, t, V, b, x))
              ? D.priority && (k = 1)
              : (X[P] = O = oi.call(t, b, P, 'get', g[P], V, x, 0, r.stringFilter));
        t._op && t._op[w] && t.kill(b, t._op[w]),
          v &&
            t._pt &&
            ((vt = t), E.killTweensOf(b, X, t.globalTime(e)), (U = !t.parent), (vt = 0)),
          t._pt && o && (Ve[A.id] = 1);
      }
      k && vr(t), t._onInit && t._onInit(t);
    }
    (t._onUpdate = f), (t._initted = (!t._op || t._pt) && !U), c && e <= 0 && T.render(ct, !0, !0);
  },
...
var N = (function (u) {
  ...
  function t(i, r, n, s) {
    ...
    var o = a.vars,
      ...
      y = o.yoyoEase,
      x = r.parent || E,
      v = ($(i) || Li(i) ? yt(i[0]) : 'length' in r) ? [i] : ot(i),
      T,
      g,
      w,
      P,
    ...
    if (
      ((a._targets = v.length
        ? si(v)
        : ae('GSAP target ' + i + ' not found. https://gsap.com', !rt.nullTargetWarn) || []),
      (a._ptLookup = []),
      (a._overwrite = d),
      p || c || pe(f) || pe(h))
    ) {
      if (
        ...
        if (((P = v.length), (k = c && tr(c)), dt(c)))
          for (O in c) ~pr.indexOf(O) && (A || (A = {}), (A[O] = c[O]));
        for (g = 0; g < P; g++)
          (w = Te(r, mr)),
            (w.stagger = 0),
            y && (w.yoyoEase = y),
        ...
        re(st(T.vars.defaults, { ease: 'none' })), (T._ease = Lt(p.ease || r.ease || 'none'));
        var M = 0,
          D,
          X,
          V;
        if ($(p))
          ...
          for (O in w)
            for (
              ...
              (X = D[g]),
                (V = { ease: X.e, duration: ((X.t - (g ? D[g - 1].t : 0)) / 100) * f }),
                (V[O] = X.v),
                T.to(v, V, M),
                (M += V.duration);
    ...
    return (
      d === !0 && !He && ((vt = mt(a)), E.killTweensOf(v), (vt = 0)),
      _t(x, mt(a), n),
      r.reversed && a.reverse(),
      r.paused && a.paused(!0),
      (l || (!f && !p && a._start === B(x._time) && Q(l) && qr(mt(a)) && x.data !== 'nested')) &&
        ((a._tTime = -1e-8), a.render(Math.max(0, -h) || 0)),
      m && Zi(mt(a), m),
      a
    );
  }
  ...
  return (
      ...
      if (!f) Gr(this, r, n, s);
        ...
        if (((c = l), (v = this.timeline), this._repeat)) {
          ...
          if (
            ...
            l === o
              ? ((p = this._repeat), (c = f))
              : ((m = B(l / _)), (p = ~~m), p && p === m ? ((c = f), p--) : c > f && (c = f)),
            (y = this._yoyo && p & 1),
          ...
          p !== m &&
            (v && this._yEase && _r(v, y),
            this.vars.repeatRefresh &&
              !y &&
              !this._lock &&
              c !== _ &&
              this._initted &&
              ((this._lock = s = 1), (this.render(B(_ * p), !0).invalidate()._lock = 0)));
        }
        if (!this._initted) {
        ...
        (v && v.render(r < 0 ? r : v._dur * v._ease(c / this._dur), n, s)) ||
          ...
          this._onUpdate && !n && (h && Ue(this, r, n, s), it(this, 'onUpdate')),
          this._repeat &&
            p !== m &&
            this.vars.onRepeat &&
            !n &&
          ...
          (l === this._tDur || !l) &&
            this._tTime === l &&
            (h && !this._onUpdate && Ue(this, r, !0, !0),
            (r || !f) &&
    ...
    (e.resetTo = function (r, n, s, a, o) {
      ...
      var f = Math.min(this._dur, (this._dp._time - this._start) * this._ts),
        h;
      return (
        this._initted || ui(this, f),
        (h = this._ease(f / this._dur)),
        ln(this, r, n, s, a, h, f, o)
          ? this.resetTo(r, n, s, a, 1)
          : (Ce(this, 0),
            this.parent || Ki(this._dp, this, '_first', '_last', this._dp._sort ? '_start' : 0),
            this.render(0))
      );
    }),
    (e.kill = function (r, n) {
      if ((n === void 0 && (n = 'all'), !r && (!n || n === 'all')))
        return (
          ...
          this.parent ? ee(this) : this.scrollTrigger && this.scrollTrigger.kill(!!q),
          this
        );
      if (this.timeline) {
      ...
      for (
        ...
        if (~o.indexOf(a[y])) {
          ...
          for (_ in p)
            (m = c && c[_]),
              m && ((!('kill' in m.d) || m.d.kill(_) === !0) && Se(this, m, '_pt'), delete c[_]),
              d !== 'all' && (d[_] = 1);
        }
...
st(N.prototype, { _targets: [], _lazy: 0, _startAt: 0, _op: 0, _onInit: 0 });
...
var fi = function (t, e, i) {
  ...
  hi = function (t, e) {
    return F(t[e]) ? gr : Je(t[e]) && t.setAttribute ? mn : fi;
  },
  yr = function (t, e) {
  ...
  xn = function (t) {
    for (var e = this._pt, i, r; e; )
      (r = e._next),
        (e.p === t && !e.op) || e.op === t ? Se(this, e, '_pt') : e.dep || (i = 1),
        (e = r);
    return !i;
  },
  vn = function (t, e, i, r) {
...
var It = [],
        ...
        return (
          this.data.forEach(function (r) {
            return r instanceof u
              ...
              : r instanceof N && !(r.parent && r.parent.data === 'nested') && i.push(r);
          }),
          i
        );
      }),
          ...
          f === 'all'
            ...
            : ((o = ht.matchMedia(i[f])),
              o &&
                ...
                (a[f] = o.matches) && (h = 1),
                o.addListener ? o.addListener($e) : o.addEventListener('change', $e)));
        return (
          h &&
            r(s, function (l) {
              return s.add(null, l);
  ...
  we = {
    ...
    quickTo: function (t, e, i) {
      var r,
        n = J.to(t, st(((r = {}), (r[e] = '+=0.1'), (r.paused = !0), (r.stagger = 0), r), i || {})),
        s = function (o, f, h) {
    ...
    exportRoot: function (t, e) {
      ...
      for (
        ...
        (n = r._next),
          (e || !(!r._dur && r instanceof N && r.vars.onComplete === r._targets[0])) &&
            _t(i, r, r._start - r._delay),
          (r = n);
      return _t(E, i, 0), i;
    },
    context: function (t, e) {
      return t ? new Tr(t, e) : R;
    },
    ...
    for (r in e)
      for (n = i.length; n--; )
        (s = t._ptLookup[n][r]),
          s &&
            (s = s.d) &&
            (s._pt && (s = Pn(s, r)), s && s.modifier && s.modifier(e[r], t, i[n], r));
  },
  Fe = function (t, e) {
    return {
      name: t,
 ...
 */ var Pi,
  ...
  Cn = /[\s,\(]\S/,
  lt = { autoAlpha: 'opacity,visibility', scale: 'scaleX,scaleY', alpha: 'opacity' },
  Ke = function (t, e) {
    ...
    for (n = 0; n < t.length; n += 3)
      t[n + 1]
        ...
        : t[n + 2]
          ? (i[t[n]] = t[n + 2])
          : i.removeProperty(
              t[n].substr(0, 2) === '--' ? t[n] : t[n].replace(di, '-$1').toLowerCase(),
            );
    if (this.tfm) {
  ...
  Or = function (t, e) {
    var i = { target: t, props: [], revert: Bn, save: Nn };
    return (
  ...
  Ze = function () {
    Sn() &&
      ...
      (z = jt(z)),
      (H = z + 'Origin'),
      (Et.style.cssText = 'border-width:0;line-height:0;position:absolute;padding:0'),
      (Sr = !!jt('perspective')),
      (ci = J.core.reverting),
      (li = 1));
  },
      ...
      e in xt && e !== H && (e = z),
        i.removeProperty
          ? ((r = e.substr(0, 2)),
            ...
            i.removeProperty(r === '--' ? e : e.replace(di, '-$1').toLowerCase()))
          : i.removeAttribute(e);
    }
  },
  ...
  St = function u(t, e, i, r) {
    ...
    if (
      ...
      return (
        (p = y ? t.getBBox()[o ? 'width' : 'height'] : t[h]), L(d ? (n / p) * l : (n / 100) * p)
      );
    if (
    ...
    if (d && (e === 'height' || e === 'width')) {
      ...
      (d || s === '%') && !Vn[ut(_, 'display')] && (a.position = ut(t, 'position')),
  ...
  gt = function (t, e, i, r) {
    ...
    return (
      li || Ze(),
      e in lt && e !== 'transform' && ((e = lt[e]), ~e.indexOf(',') && (e = e.split(',')[0])),
      xt[e] && e !== 'transform'
        ? ((n = le(t, r)),
          (n =
            e !== 'transformOrigin'
              ...
              : n.svg
                ? n.origin
                : Oe(ut(t, H)) + ' ' + n.zOrigin + 'px'))
        : ((n = t.style[e]),
          (!n || n === 'auto' || r || ~(n + '').indexOf('calc(')) &&
            (n = (Pe[e] && Pe[e](t, e, i)) || ut(t, e) || qi(t, e) || (e === 'opacity' ? 1 : 0))),
      i && !~(n + '').trim().indexOf(' ') ? St(t, e, n, i) + i : n
    );
  },
  Un = function (t, e, i, r) {
    if (!i || i === 'none') {
    ...
    if (
      ...
      (i += ''),
      (r += ''),
      r.substring(0, 6) === 'var(--' && (r = ut(t, r.substring(4, r.indexOf(')')))),
      r === 'auto' &&
        ((_ = t.style[e]), (t.style[e] = r), (r = ut(t, e) || r), _ ? (t.style[e] = _) : Nt(t, e)),
      (h = [i, r]),
      fr(h),
      (i = h[0]),
      (r = h[1]),
      ...
      for (; (l = Ut.exec(r)); )
        (m = l[0]),
          ...
          m !== (_ = c[f++] || '') &&
            ...
            (y = parseFloat(m)),
            (v = m.substr((y + '').length)),
            (o = Ut.lastIndex - v.length),
            v || ((v = v || rt.units[e] || T), o === r.length && ((r += v), (a.e += v))),
            T !== v && (d = St(t, e, _, v) || 0),
            (a._pt = {
              _next: a._pt,
              p: x || f === 1 ? x : ',',
  ...
  Ri = function (t) {
    var e = ut(t, z);
    return Dr(e) ? _e : e.substr(7).match(Ii).map(L);
  },
  pi = function (t, e) {
    var i = t._gsap || zt(t),
      r = t.style,
  ...
  le = function (t, e) {
    ...
    return (
      ...
      i.svg &&
        ...
        je(t, U || f, !!U || i.originIsAbsolute, i.smooth !== !1, P)),
      (g = i.xOrigin || 0),
      (w = i.yOrigin || 0),
      P !== _e &&
        ((A = P[0]),
        ...
        P.length === 6
          ...
          : ((Mt = P[6]),
            ...
            (d = L(Math.sqrt(A * A + M * M + D * D))),
            (p = L(Math.sqrt(I * I + Mt * Mt))),
            (O = Vt(V, I)),
            (x = Math.abs(O) > 2e-4 ? O * Rt : 0),
            (T = pt ? 1 / (pt < 0 ? -pt : pt) : 0)),
        i.svg &&
          ((U = t.getAttribute('transform')),
          (i.forceCSS = t.setAttribute('transform', '') || !Dr(ut(t, z))),
      ...
      (i.zOrigin = parseFloat(f.split(' ')[2]) || (!e && i.zOrigin) || 0) && (r[H] = Oe(f)),
      (i.xOffset = i.yOffset = 0),
      (i.force3D = rt.force3D),
      (i.renderTransform = i.svg ? Wn : Sr ? Ar : qn),
      (i.uncache = 0),
      i
    );
  },
  ...
  Wn = function (t, e) {
    ...
    (o = parseFloat(o)),
      ...
      ((v && !~(s + '').indexOf('px')) || (T && !~(a + '').indexOf('px'))) &&
        ((v = St(d, 'x', s, 'px')), (T = St(d, 'y', a, 'px'))),
      (p || _ || m || y) &&
        ((v = L(v + p - (p * g + _ * P) + m)), (T = L(T + _ - (p * w + _ * O) + y))),
      (r || n) &&
        ((b = d.getBBox()), (v = L(v + (r / 100) * b.width)), (T = L(T + (n / 100) * b.height))),
      (b = 'matrix(' + g + ',' + w + ',' + P + ',' + O + ',' + v + ',' + T + ')'),
  ...
  Gn = function (t, e, i, r, n) {
    ...
    return (
      a &&
        ((l = n.split('_')[1]),
        l === 'short' && ((f %= s), f !== f % (s / 2) && (f += f < 0 ? s : -360)),
        l === 'cw' && f < 0
          ? (f = ((f + s * Si) % s) - ~~(f / s) * s)
          : l === 'ccw' && f > 0 && (f = ((f - s * Si) % s) - ~~(f / s) * s)),
  ...
  $n = function (t, e, i) {
    ...
    r.svg
      ...
      : ((f = getComputedStyle(i)[z]), (s[z] = e), (a = le(i, 1)), (s[z] = f));
    for (o in xt)
      (f = r[o]),
        (h = a[o]),
        f !== h &&
          ...
          ((d = W(f)),
          (p = W(h)),
          (l = d !== p ? St(i, o, f, p) : parseFloat(f)),
          (c = parseFloat(h)),
          (t._pt = new j(t._pt, a, o, l, c - l, Ke)),
          (t._pt.u = p || 0),
          t._props.push(o));
    Ei(a, r);
  };
...
var Rr = {
      ...
      if (_ !== 'autoRound' && ((h = e[_]), !(tt[_] && dr(_, e, i, r, t, n)))) {
        if (
          ...
          (f = (getComputedStyle(t).getPropertyValue(_) + '').trim()),
            (h += ''),
            (Pt.lastIndex = 0),
            Pt.test(f) || ((m = W(f)), (y = W(h))),
            y ? m !== y && (f = St(t, _, f, y) + y) : m && (h += m),
          ...
          if (
            (o && _ in o
              ? ((f = typeof o[_] == 'function' ? o[_].call(i, r, t, n) : o[_]),
                Y(f) && ~f.indexOf('random(') && (f = ue(f)),
                W(f + '') || f === 'auto' || (f += rt.units[_] || W(gt(t, _)) || ''),
                (f + '').charAt(1) === '=' && (f = gt(t, _)))
              : (f = gt(t, _)),
            (c = parseFloat(f)),
            ...
            if (
              ...
              d === 'string' &&
                h.substring(0, 6) === 'var(--' &&
                ((h = ut(t, h.substring(4, h.indexOf(')')))), (l = parseFloat(h))),
              T ||
                ((g = t._gsap),
                (g.renderTransform && !e.parseTransform) || le(t, e.parseTransform),
                (w = e.smoothOrigin !== !1 && g.smooth),
                (T = this._pt = new j(this._pt, a, z, 0, 1, g.renderTransform, g, 0, -1)),
                (T.dep = 1)),
              _ === 'scale')
            )
              (this._pt = new j(
          ...
          if (v || ((l || l === 0) && (c || c === 0) && !Cn.test(h) && _ in a))
            (m = (f + '').substr((c + '').length)),
              l || (l = 0),
              (y = W(h) || (_ in rt.units ? rt.units[_] : m)),
              m !== y && (c = St(t, _, f, y)),
              (this._pt = new j(
                this._pt,
                v ? g : a,
                ...
                c,
                (x ? Xt(c, x + l) : l) - c,
                !v && (y === 'px' || _ === 'zIndex') && e.autoRound !== !1 ? An : Ke,
              )),
              (this._pt.u = y || 0),
              m !== y && y !== '%' && ((this._pt.b = f), (this._pt.r = Dn));
  ...
  render: function (t, e) {
    if (e.tween._time || !ci()) for (var i = e._pt; i; ) i.r(t, i.d), (i = i._next);
